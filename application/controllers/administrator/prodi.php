...
class Prodi extends CI_Controller{
	public function _rules(){
		$this->form_validation->set_rules('kode_prodi', 'Kode Prodi', 'required', ['required' => 'Kode prodi harus diisi!']);
		$this->form_validation->set_rules('nama_prodi', 'Nama Prodi', 'required', ['required' => 'Nama prodi harus diisi!']);
		$this->form_validation->set_rules('nama_jurusan', 'Nama Jurusan', 'required', ['required' => 'Nama jurusan harus diisi!']);
	}
	...
	public function tambah_prodi_aksi(){
		...
		if($this->form_validation->run() == FALSE){
			...
			$this->session->set_flashdata('pesan', '<div class="alert alert-info">Data prodi berhasil ditambahkan!</div>');
	...
	public function update_aksi(){
		...
		$this->session->set_flashdata('pesan', '<div class="alert alert-info">Data prodi berhasil diperbarui!</div>');
		redirect('administrator/prodi');
	}
	...
	public function delete($id){
		...
		$this->session->set_flashdata('pesan', '<div class="alert alert-danger">Data prodi berhasil dihapus!</div>');
		redirect('administrator/prodi');
	}
}