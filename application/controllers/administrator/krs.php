...
class Krs extends CI_Controller{
	...
	public function tambah_krs_aksi(){
		...
		if($this->form_validation->run() == FALSE){
			...
			$this->session->set_flashdata('pesan', '<div class="alert alert-info">Data KRS berhasil ditambahkan!</div>');
			redirect('administrator/krs/index');
		}
	}

	public function _rules(){
		$this->form_validation->set_rules('id_thn_akad', 'Tahun Akademik', 'required', ['required' => 'Tahun Akademik Harus diisi']);
		$this->form_validation->set_rules('nim', 'NIM', 'required', ['required' => 'NIM Harus diisi']);
	...
	public function update_aksi(){
		...
		$this->session->set_flashdata('pesan', '<div class="alert alert-info">Data KRS berhasil diperbarui!</div>');
			redirect('administrator/krs/index');
	}
	...
	public function delete($id){
		...
		$this->session->set_flashdata('pesan', '<div class="alert alert-danger">Data KRS berhasil dihapus!</div>');
		redirect('administrator/krs/index');
	}
}