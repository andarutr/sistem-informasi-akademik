...
class Matakuliah extends CI_Controller{
	public function _rules(){
		...
		$this->form_validation->set_rules('nama_matakuliah', 'Nama Matakuliah', 'required', ['required' => 'Nama matakuliah harus diisi!']);
	...
	public function tambah_matakuliah_aksi(){
		...
		if($this->form_validation->run() == FALSE){
			...
			$this->session->set_flashdata('pesan', '<div class="alert alert-info">Data matakuliah berhasil ditambahkan!</div>');
	...
	public function update_aksi(){
		...
		$this->session->set_flashdata('pesan', '<div class="alert alert-info">Data Mata Kuliah berhasil diperbarui!</div>');
		redirect('administrator/matakuliah');
	}
	...
	public function delete($id){
		...
		$this->session->set_flashdata('pesan', '<div class="alert alert-danger">Data Mata Kuliah berhasil dihapus!</div>');
		redirect('administrator/matakuliah');
	}
}