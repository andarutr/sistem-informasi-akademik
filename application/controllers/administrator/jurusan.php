...
class Jurusan extends CI_Controller{
	public function _rules(){
		$this->form_validation->set_rules('kode_jurusan', 'Kode Jurusan', 'required', ['required' => 'Kode jurusan harus diisi!']);
	...
	public function input_aksi(){
		...
		if($this->form_validation->run() == FALSE){
			...
			$this->session->set_flashdata('pesan', '<div class="alert alert-primary">Data jurusan berhasil ditambahkan!</div>');
	...
	public function update_aksi(){
		...
		$this->session->set_flashdata('pesan', '<div class="alert alert-info">Data jurusan berhasil diperbarui!</div>');
		redirect('administrator/jurusan');
	}
	...
	public function delete($id){
		...
		$this->session->set_flashdata('pesan', '<div class="alert alert-danger">Data jurusan berhasil dihapus!</div>');
		redirect('administrator/jurusan');
	}
}